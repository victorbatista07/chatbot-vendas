...
const financialInstrumentCpfCnpjValidator = (number) => {
    let _ex = /[^0-9]/g;
    ...
    // throw new Error('A criptografia do cpf/cnpj do proprietário do instrumento de financiamento não deve conter 0 ou mais de 50 caracteres.');
};

module.exports = {
    financialInstrumentCpfCnpjValidator
};
